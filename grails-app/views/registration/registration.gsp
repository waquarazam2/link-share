...
<a href="/linksharing/login/login.gsp" class="SignIn">Sign in</a>
<g:form controller="registration" action="addUser" enctype="multipart/form-data">
    <table align="center" class="Table">
        ...
        <tr>
            <td><input type="text" name="firstName" class="Text" placeholder="Enter The First Name"></td>
            <td><input type="text" name="lastName" class="Text" placeholder="Enter The Last Name"></td>
        </tr>
        <tr>
            <td>Email</td>
            <td>User Name</td>
        ...
        <tr>
            ...
            <td><g:textField type="text" name="userName" class="Text" placeholder="Choose User Name"></g:textField></td>
        </tr>
        <tr>
            <td>Password</td>
        ...
        <tr>
            <td><g:passwordField name="password" class="Text" placeholder="Enter Password"></g:passwordField></td>
