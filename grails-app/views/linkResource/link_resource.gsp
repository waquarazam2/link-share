...
<h2 style="text-align: center;color:rgba(117, 33, 46, 0.98);">Share Link to People</h2>
<g:form controller="linkResource" action="addLinkResource">
    <table class="Document">
        <tr>
            <td>URL *</td>
            <td><input type="url" name="url" class="Text"></td>
        </tr>
        <tr>
            <td>Description *</td>
