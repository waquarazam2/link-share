            ...
            <div style="margin-top:1%;font-size: 90%;">
                ...
                <div style="float:right;width:45%;">
                    <g:if test="${user.user.active}">
                        <a  href="javascript:void(0)" id="/linksharing/user/block/?id=${user.user.id}" class="SignIn User">block</a>
                    </g:if>
                    <g:else>
                        <a  href="javascript:void(0)" id="/linksharing/user/block/?id=${user.user.id}" class="SignIn User">unblock</a>
                    </g:else>
